...
describe('S3Service', () => {
    ...
    beforeEach(() => {
        ...
        aws_sdk_1.default.S3.mockImplementation(() => mockS3);
    ...
    describe('generateUploadUrl', () => {
        ...
        it('should throw ValidationError when key is empty', async () => {
            ...
            await expect(s3Service.generateUploadUrl('', options)).rejects.toThrow(auth_1.ValidationError);
        ...
        it('should throw ValidationError when content type is missing', async () => {
            ...
            await expect(s3Service.generateUploadUrl(key, options)).rejects.toThrow(auth_1.ValidationError);
    ...
    describe('verifyUpload', () => {
        ...
        it('should throw ValidationError when key is empty', async () => {
            await expect(s3Service.verifyUpload('')).rejects.toThrow(auth_1.ValidationError);
    ...
    describe('upload', () => {
        ...
        it('should throw ValidationError when buffer is empty', async () => {
            ...
            await expect(s3Service.upload(key, buffer)).rejects.toThrow(auth_1.ValidationError);
